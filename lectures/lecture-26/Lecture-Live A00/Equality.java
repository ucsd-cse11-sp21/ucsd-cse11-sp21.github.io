...
class Point {
     ...
     * @return true if the points have the same x and y cooridnates, false otherwise
     */
    ...
    boolean equals(Point other) {
        //ystem.out.println("Calling our equals method now!");
        return this.x == other.x && this.y == other.y;        
    }
...
class Equality {
    ...
    boolean numsEqualsByArrayEquals = Arrays.equals(numsA, numsB);
    ...
    boolean strsEqualsByArrayEquals = Arrays.equals(strs1, strs2);
